...
#### Included Workflows
- **Deploy to GitHub Pages** (`.github/workflows/deploy.yml`): Automatically deploys your site when you push to main
- **Code Validation** (`.github/workflows/validate.yml`): Validates HTML, CSS, JSON syntax and checks for broken links
- **Performance & Accessibility** (`.github/workflows/performance.yml`): Runs Lighthouse audits with performance thresholds
- **Security Scanning** (`.github/workflows/security.yml`): Performs vulnerability scanning and security analysis

#### Workflow Features
- **Automatic Deployment**: Push to main branch triggers deployment
- **Pull Request Validation**: All changes are validated before merging
- **Performance Monitoring**: Lighthouse CI ensures performance standards
- **Security Checks**: Automated vulnerability scanning
- **Code Quality**: HTML/CSS validation and link checking
...
#### Setup
1. Push your code to GitHub (workflows are already included)
2. Workflows will automatically run on pushes and pull requests
3. Check the "Actions" tab in your repository for workflow results
